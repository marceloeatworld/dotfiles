...

{
  ...
  environment.systemPackages = (with pkgs; [
    ...
    # ============================================
    python313Packages.angr      # Binary analysis platform (symbolic execution, CFG recovery)
    python313Packages.angrcli   # Interactive angr CLI
    python313Packages.angrop    # ROP gadget finder and chain builder
