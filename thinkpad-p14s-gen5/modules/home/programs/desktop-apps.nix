...
in
{
  ...
  xdg.desktopEntries = {
    # Brave browser - explicit .desktop needed for MIME defaults (Firejail wrapper
    # doesn't propagate the upstream brave-browser.desktop to XDG search paths)
    brave-browser = {
    ...
    ghidra = {
      ...
      exec = "ghidra";  # Uses Firejail wrapper from security.nix
      icon = "ghidra";
      terminal = false;
      type = "Application";
    ...
    wireshark = {
      ...
      exec = "wireshark";  # Uses Firejail wrapper from security.nix
      icon = "wireshark";
      terminal = false;
      type = "Application";
    ...
    gimp = {
      ...
      exec = "gimp %U";  # Uses Firejail wrapper from security.nix
      icon = "gimp";
      terminal = false;
      type = "Application";
    ...
    hashcat = {
      ...
      exec = "ghostty --wait-after-command -e hashcat --help";
    ...
    aircrack-ng = {
      ...
      exec = "ghostty --wait-after-command -e aircrack-ng --help";
    ...
    wifite = {
      ...
      exec = "ghostty --wait-after-command -e sudo wifite --help";
    ...
    bettercap = {
      ...
      exec = "ghostty --wait-after-command -e sudo bettercap --help";
      icon = "network-wired";
      terminal = false;
      type = "Application";
      categories = [ "Network" "Security" ];
    ...
    sqlmap = {
      ...
      exec = "ghostty --wait-after-command -e sqlmap --help";
      icon = "database";
      terminal = false;
      type = "Application";
    ...
    nikto = {
      ...
      exec = "ghostty --wait-after-command -e nikto --help";
      icon = "web-browser";
      terminal = false;
      type = "Application";
      categories = [ "Network" "Security" ];
