...

{
  programs.mangohud = {
    ...
    settings = {
      ...
      text_color = stripHash theme.colors.foreground;
      gpu_color = stripHash theme.colors.orange;
      cpu_color = stripHash theme.colors.green;
      vram_color = stripHash theme.colors.yellow;
      ram_color = stripHash theme.colors.magenta;
      engine_color = stripHash theme.colors.orange;
      frametime_color = stripHash theme.colors.cyan;
      background_color = stripHash theme.colors.background;
    };
  };
}
