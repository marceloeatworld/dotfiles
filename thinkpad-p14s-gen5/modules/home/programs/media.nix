...
in
{
  ...
  home.packages = (with pkgs; [
    ...
    spotify
    vlc
    obs-studio      # Screen recording and streaming - wrapped by Firejail in security.nix
    gimp3           # GIMP 3.0.4 with PhotoGIMP (Photoshop-like interface) - wrapped by Firejail in security.nix
    inkscape        # Vector graphics - wrapped by Firejail in security.nix
