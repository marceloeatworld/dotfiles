...
**Features:**
- Hyprland tiling WM with hyprbars plugin
...
- **Home Manager** - Declarative user environment (32 modules)
...
| `update-apps` | `update-overlays && nh os switch` | Update VS Code, Claude Code, llama.cpp |
...
| `update-overlays` | Update all overlays |
